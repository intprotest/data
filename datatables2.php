...
<html lang="en" style="overflow-x: hidden;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">  
        ...
        <meta name="viewport" content="width=device-width, initial-scale=1">
                ...
                <title>Internet Trends | IPv6 Adoption by Country, Network | Data Visualization</title>
                
     <!--  data
================================================== --> 
		   <script src="http://caucasusoffline.com/data/1/country.json" type="text/javascript"></script>
            <script src="http://caucasusoffline.com/data/1/asn.json" type="text/javascript"></script>  
...
================================================== --> 
  ...
  <link href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" rel="stylesheet">
      ...
      <link href="http://caucasusoffline.com/data/1/css" rel="stylesheet" type="text/css">
...
<script src="http://caucasusoffline.com/data/1/chart_options.js"></script>
...
================================================== --> 
   ...
   <script src="http://caucasusoffline.com/data/1/jquery.tabSlideOut.v1.3.js"></script>
   <script src="http://caucasusoffline.com/data/1/dom.js"></script>  
...
================================================== --> 
    ...
    <body class="bodybg visaulization_body customize-support" style="background:url(uploads/data-vis-security-banner.jpg);">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-4 col-sm-4">
                            <div class="logo"> <a urltype="homeroot" class="hidden-xs" href="http://www.caucasusoffline.com">
<img src="http://caucasusoffline.com/data/1/logo1.png" alt="logo"></a>
 <a urltype="homeroot" class="visible-xs" href="http://www.caucasusoffline.com/">
<img src="http://caucasusoffline.com/data/1/logo-sml.png" alt="logo"></a></div>
                        </div>
                        <div class="col-md-6 col-md-offset-2  col-sm-8"> </div>
                    </div>
                </div>
            </div>
                ...
                <div class="container-fluid">
                    <div class="col-md-12"><div class="breadcrumb"></div></div>
                </div>
...
<h2><font>State of the Internet &nbsp;</font> <span>IPv6 Adoption Visualization</span></h2>
</div>
<div class="col-md-6 col-sm-6 col-xs-6">
<div class="ipv6btn"><a class="btn btnNew" data-toggle="tooltip" data-placement="top" title="" href="#networks" data-original-title="Note that the Networks 
ranking is determined by the volume of IPv6 requests to Akamai.">Networks</a><a class="btn btnNew green"
 href="#countries" data-original-title="" title="">Countries</a></div>
</div>
</div>
</div>
<div class="data-body">
...
<div id="country_data_div"><div><div class="tablebody"><div id="country_data_table_wrapper" class="dataTables_wrapper no-footer">
<div id="country_data_table_filter" class="dataTables_filter">

<label>Search:<input type="search" class="" placeholder="Search" aria-controls="country_data_table"></label></div>

<table width="100%" cellpadding="0" cellspacing="0" border="0" class="display dataTable no-footer" id="country_data_table" role="grid">



<thead><tr role="row" title="Click on the bar to view the graph">

<th class="sorting" tabindex="0" aria-controls="country_data_table" rowspan="1" colspan="1" aria-label="Rank: activate to sort column ascending" style="width: 15%;">Rank</th>
<th class="sorting_desc" tabindex="0" aria-controls="country_data_table" rowspan="1" colspan="1" aria-sort="descending" aria-label="IPv6 %: activate to sort column ascending" style="width: 15%;">IPv67 %</th>
<th class="sorting" tabindex="0" aria-controls="country_data_table" rowspan="1" colspan="1" aria-label="Country: activate to sort column ascending" style="width: 15%;">Country</th>
<th class="sorting_disabled" rowspan="1" colspan="1" aria-label=""></th></tr></thead></table></div></div></div></div>
<div id="asn_data_div" style="display: none">Network</div>
</div>
</div>
<div class="datafooter">
<div class="pull-left">Data last updated: <span>12/15/2014</span></div>
<div class="pull-left"><a href="http://caucasusoffline.com/data/1/asn.json" download="">Download network data</a>&nbsp;|&nbsp;<a href="http://caucasusoffline.com/data/1/country.json" download="">Download country data</a></div>
...
</section></div><div id="_atssh" style="visibility: hidden; height: 1px; width: 1px; position: absolute; top: -9999px; z-index: 100000;">
</div>

<table cellspacing="0" cellpadding="0" class="gstl_50 gssb_c" style="width: 182px; display: none; top: 45px; position: absolute; left: 958px;">
<tbody><tr><td class="gssb_f"></td><td class="gssb_e" style="width: 100%;"></td></tr></tbody></table></body>
